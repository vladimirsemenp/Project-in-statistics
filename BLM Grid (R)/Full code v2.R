# i use semicolons for clearness
# i know that they are unnecessary
...
#here we create and test our package
#
...
?summary.BMLGrid
#setwd("./BMLGrid/man")
#prompt(createBMLGrid)
#prompt(runBMLGrid)
#prompt(getAnywhere(plot.BMLGrid))
#prompt(getAnywhere(summary.BMLGrid))
